...
public class RatingReviews extends FrameLayout {
    ...
    public RatingReviews(Context mCtx, AttributeSet attrs) {
        ...
        mBarDimension = a.getDimensionPixelSize(R.styleable.RatingReviews_width, (int) Utils.convertDpToPixel(20, mCtx));
        mBarColor = a.getColor(R.styleable.RatingReviews_color, Utils.DEFAULT_BAR_COLOR);
        mBarTextSize = (int) Utils.convertPixelsToDp(a.getDimensionPixelSize(R.styleable.RatingReviews_text_size,
        ...
        mBarSpaces = a.getDimensionPixelSize(R.styleable.RatingReviews_spaces, (int) Utils.convertDpToPixel(Utils.DEFAULT_BAR_SPACE, mCtx));
    ...
    private void initLayout() {
        ...
        mLinearParentLayout.setLayoutParams(new LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT,
     ...
     * @param view       view.
     */
    private void draw(int dimension, Bar initialBar, final Bar bar, View view) {
        if (bar.getColor() != 0) {
            view.findViewById(R.id.linear_bar).setBackgroundColor(bar.getColor());
        } else {
            view.findViewById(R.id.linear_bar).setBackgroundColor(mBarColor);
        }
